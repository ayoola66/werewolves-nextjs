...
export default function WerewolfGame() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      {/* Main content */}
      <div
        className={`relative z-10 text-white flex items-center justify-center min-h-screen p-4 transition-all duration-1000 ${
      ...
      >
        <div className="w-full max-w-5xl mx-auto">
          {gameState.currentScreen === "initial" && (
            <InitialScreen gameState={gameState} />
          )}
