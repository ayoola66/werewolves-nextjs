...
export default function EliminatedOverlay({
  ...
  const roleInfo = playerRole
    ? ROLE_INFO[playerRole as keyof typeof ROLE_INFO]
    : null;
  ...
  return (
    <div
      className={`fixed inset-0 bg-gradient-to-br ${eliminationInfo.bgGradient} flex flex-col items-center justify-center z-[60] p-4`}
    >
      <div className="text-center animate-in fade-in zoom-in duration-700">
        {/* Skull/Death Icon */}
        <div className="text-8xl sm:text-9xl mb-6 animate-pulse">💀</div>
          ...
          <CardContent className="text-center">
            ...
            <p className="text-gray-400 text-sm">
              {roleInfo?.description ||
                "Your role has been revealed to the other players."}
            </p>
          </CardContent>
        </Card>
